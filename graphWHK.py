...
import random
import AdaptedWHK
importlib.reload(AdaptedWHK)

from AdaptedWHK import WHKModel2
...
config.add_model_parameter("epsilon", Parameters.eps) 
#set media/antimedia vertices
if num_paidposts>0:
    list1 =[]
    for i in range(0, num_paidposts):
        list1.append(N+i)
...
#set media/antimedia as stubborn
for n in nodes:
    if n >N:
